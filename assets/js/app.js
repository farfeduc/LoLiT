...
LoLiT.controller('LoLiTCtrlPart1', ['$scope', '$rootScope', '$http', function($scope, $rootScope, $http) {
...
LoLiT.controller('LoLiTCtrlPart2', ['$scope', '$rootScope', '$http', function($scope, $rootScope, $http) {
  ...
  $rootScope.sectionSelectionnee = 2;
...
LoLiT.controller('LoLiTCtrlPart3', ['$scope', '$rootScope', '$http', function($scope, $rootScope, $http) {
